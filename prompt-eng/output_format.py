...
prompt1 = "Generate a table containing 10 must-read science fiction books for a sci-fi lover. The table must have columns: Title, Author, and Year."
...
instructions2 = "Determine the language of the following text and generate a suitable title for it. The text will be provided inside triple backticks."

output_format2 = "Text:\nLanguage:\nTitle:"

prompt2 = instructions2 + "\n" + output_format2 + f"\n```{text2}```"
...
instructions3 = "Determine the language of the given text and count the number of sentences. If the text has more than one sentence, generate a suitable title. If it has only one sentence, write 'N/A' for the title. Text will be inside triple backticks."
